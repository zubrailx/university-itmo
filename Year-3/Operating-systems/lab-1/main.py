...
def parse_and_display_cpu(path):
    ...
    fig.tight_layout()
    plt.savefig("images/fig-cpu.png")
    plt.clf()
    ...
    ax.legend()
    plt.savefig("images/fig-cpu-1.png")
    plt.clf()
    ...
    fig.tight_layout()
    plt.savefig("images/fig-mem.png")
    plt.clf()
    return data_cpu
...
def parse_and_display_net(path):
    ...
    fig.tight_layout()
    plt.savefig("images/fig-net.png")
    plt.clf()
    return data_net
...
def parse_and_display_state(path):
    data_state = {
        ...
        "pattern_data": r"^\s+(\d+)\s+(\S+)\s+(\d+)\s+(\d+)\s+(\d+)\s+(\d+)\s+(\d+)\s+(\S)\s+(\d+\.\d+)\s+(\d+\.\d+)\s+(\d+:\d+\.\d+)\s+(\S+)$",
        "data" : []
    }
    ...
    plt.tight_layout()
    plt.savefig("images/fig-state.png", dpi=300)
    plt.clf()
    ...
    plt.tight_layout()
    plt.savefig("images/fig-state-vert.png", dpi=300)
    plt.clf()
    return data_state
