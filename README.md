...
В ходе выполнения данной лабораторной работы настрадался с move-семантикой и шаблонами, впервые поиспользовал `boost`, научился нормально писать (вроде бы) cmake, разобрался с библиотекой `gGRPC`.
