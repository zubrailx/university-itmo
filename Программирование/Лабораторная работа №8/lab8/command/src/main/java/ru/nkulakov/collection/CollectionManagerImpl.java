...
import ru.nkulakov.file.FileManager;
import ru.nkulakov.file.XmlParser;
...
public class CollectionManagerImpl implements CollectionManager {
    ...
    public CollectionManagerImpl(Dragon[] dragons) {
        this.treeMap = new TreeMap<>();
...
//    }
    ...
    public TreeMap<Integer, Dragon> getTreeMap() {
        return treeMap;
    }
}