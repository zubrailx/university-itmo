...
public class ReplaceIfGreaterCommand extends Command {
    ...
    public ReplaceIfGreaterCommand(CollectionManager collectionManager, CollectionDatabaseHandler cdh) {
        this.cdh = cdh;
...
//                    printStream.println("\nВыберите поля для изменения:");
            ...
            try {
                ...
                if (cdh.isOwner(id, userData)) {
                    ...
                    Dragon dragon = DragonFieldReplacer.replaceIfGreater(cdh.getDragonById(id), fields, values, printStream);
    ...
    public String getDescription() {
        return "replaces the field if the proper one is greater";
    }
