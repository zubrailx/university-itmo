package ru.nkulakov.file;

import ru.nkulakov.collection.*;
import ru.nkulakov.exceptions.ValidValuesRangeException;
...
public class DragonFieldsReader {
    ...
    public Dragon read(Integer id) {
        ...
        DragonType dragonType = readType();
        DragonCharacter dragonCharacter = readCharacter();
        DragonCave dragonCave = readCave();
        return new Dragon(id, name, coordinates, color, age, dragonType, dragonCharacter, dragonCave, ZonedDateTime.parse(i));
    }
