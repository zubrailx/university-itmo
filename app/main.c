...
int main() {
  ...
  dto_table_add_column(t1, (char *)"weight", DTO_COLUMN_DOUBLE,
...

  {
    ...
    struct fast_const *fc_nikit = fast_const_construct(DTO_COLUMN_STRING, "nikita", dbms);
    ...
    struct fast_const *fc_weight80 =
        fast_const_construct(DTO_COLUMN_DOUBLE, &min_val, dbms);
