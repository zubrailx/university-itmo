...
\noindentДоказательство: Пусть $\omega \in A \setminus B$. Тогда $\omega \in A$, $\omega \not\in B$, $
...
\bigskip
\noindentОтвет: неверно: 1), 4), 6); верно: 2), 3), 5)
...
\bigskip
\noindentОтвет: 1) $A$, 2) $A$, 3) $\emptyset$, 4) $BA$
...
\bigskip
\noindentОтвет: a) $A = a$, b) $B = \left\{x: a \le x \le b\right\}$
...
\bigskip
\noindentОтвет: 1) $\{$ГРР, ГРГ, ГГР, ГГГ$\}$, 2) $\{$РГГ, ГРГ, ГГР$\}$, 3) $\{$РРР, РРГ, РГР, ГРР$\}$
